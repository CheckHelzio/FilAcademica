...
public class ListaEventos {
    ...
    public ArrayList<Eventos> getEventos() {
        ...
        listaEventos.add(new Eventos(
                ...
                // LISTA DE FECHAS...
                crearFechas(
                        new Fecha("A", 7, "02/12/16", "20:00", "20:00"),
                        new Fecha("B", 7, "02/12/16", "20:00", "20:15"),
                        new Fecha("C", 7, "02/12/16", "20:15", "20:30"),
                        new Fecha("D", 7, "02/12/16", "20:30", "20:45"),
                        new Fecha("E", 7, "02/12/16", "20:45", "21:15")
                )
        ));
        ...
        listaEventos.add(new Eventos(
                ...
                crearFechas(
                        ...
                        new Fecha("A", 4, "03/12/16", "11:00", "11:50")
                )
        ));
        listaEventos.add(new Eventos(
                //ID DEL EVENTO
        ...
        listaEventos.add(new Eventos(
                ...
                crearFechas(
                        ...
                        new Fecha("A", 13, "30/11/16", "11:00", "14:00"),
                        new Fecha("A", 13, "01/12/16", "11:00", "14:00")
                )
        ));
        return listaEventos;
    }
