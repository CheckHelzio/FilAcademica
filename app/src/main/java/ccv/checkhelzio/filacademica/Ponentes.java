    ...
    public void setDatos(int id) {
        switch (id) {
            case 1:
                ...
                this.dato = "Embajadora de México en Brasil";
                this.descripcion = "";
            ...
            case 13:
                ...
                this.dato = "Senador colombiano facilitador del proceso de paz en Colombia";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
