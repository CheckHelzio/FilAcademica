    ...
    public void setDatos(int id) {
        switch (id) {
            ...
            case 6:
                ...
                this.dato = "Presidente FLACSO México";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 7:
                ...
                this.dato = "Representante de Chile en la Haya";
                this.descripcion = "Ex Secretario General de la Organización de los Estados Americanos (OEA) del año 2005 al 2015; político chileno que ocupó los cargos de Ministro del Interior de Chile entre el año 2000 y 2005, así como el de Ministro de Relaciones Exteriores de Chile desde 1994 a 1999.\n Insulza fue también Director del Instituto de Estudios de Estados Unidos en el Centro de Investigación y Docencia Económicas (CIDE).";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 8:
                ...
                this.dato = "Investigador emérito UNAM";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 9:
                ...
                this.dato = "Historiador y ensayista cubano";
            ...
            case 20:
                ...
                this.dato = "Ministro de Cultura y Juventud de Costa Roca";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 21:
                ...
                this.dato = "Presidente Municipal de Guadalajara";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("2A"));
                break;
            case 22:
                ...
                this.dato = "Ex Alcalde de Los Ángeles, California.";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 24:
                ...
                this.dato = "Titular de Cultura de la Alcaldía de Panamá";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("2A"));
                break;
            ...
            case 26:
                ...
                this.dato = "Jefe de gobierno de CDMX";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("2A"));
                break;
            ...
            case 28:
                ...
                this.dato = "Ministro de Cultura de Portugal";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("2A"));
                break;
            case 29:
                ...
                this.dato = "Universidad de Guadalajara";

                this.descripcion = "Doctor en Filosofía con especialidad en Sociología (Ph. D.) por la New School for Social Research.\nActualmente funge como Rector del Centro Universitario de Ciencias Sociales y Humanidades de la Universidad de Guadalajara.\n\n Es editorialista del diario MILENIO JALISCO y miembro del Sistema Nacional de Investigadores Nivel I (SNI) desde 2009. Ha publicado Enciclopedia de la Época. Jalisco en el Mundo Contemporáneo, como coordinador y colaborador; Por una Democracia con Significado, como coordinador y participante; Creación de nuevos municipios en México, procesos y perspectivas, como coordinador y colaborador y Jalisco a Futuro, Construyendo el Porvenir, 1999-2025, como co-autor. Sus temas de investigación y docencia son la teoría social y política, la democracia, la modernidad, la filosofía política y el sistema político mexicano y jalisciense.";
            ...
            case 33:
                ...
                this.dato = "Ex Secretario de Comercio y Fomento " +
            ...
            case 34:
                ...
                this.dato = "Ex Subsecretario de Asuntos Hemisféricos de Estados Unidos";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("1B","3A"));
                break;
            case 35:
                this.nombre = "Jeffrey";
            ...
            case 36:
                ...
                this.dato = "Especialista en Seguridad Nacional";
                this.descripcion = "Abogada graduada por Harvard y la Universidad de California en Berkeley. Analista y comunicadora en programas de televisión como “El primer café”, “Contrastes  40”,  en Canal 40 de TV Azteca y programas en inglés “Imagen News” y “Living in Mexico” para grupo Imagen.\n\nLos temas que analiza versan sobre seguridad, justicia y política. Además, participa en columnas semanales en los periódicos El Universal, El Imparcial de Hermosillo, La Crónica de Mexicali, La Frontera de Tijuana, El Informador de Guadalajara, y la Opinión en California, EUA.\n\n" +
                        "Ha ocupado varios cargos públicos, fue Subsecretaria Adjunta de Defensa para Política y Apoyo Antidrogas del Departamento de Defensa de los Estados Unidos en 1998.\nTambién, fue asesora, durante su estancia en la Casa Blanca, del Enviado Especial para las Américas del Presidente Clinton en 1997. En Colombia se desempeñó como Agregada Judicial en la Embajada de los Estados Unidos en Bogotá. Debido a su desempeño en el Pentágono, la revista Hispanic Business Magazine la reconoció como uno de los 100 Hispano Americanos más influyentes en los EEUU.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 37:
                ...
                this.dato = "Analista de política internacional";
            ...
            case 39:
                ...
                this.dato = "Investigador y especialista en política exterior de México " +
                        "Universidad de Guadalajara";
                this.descripcion = "Es Profesor-Investigador de tiempo completo en la División de Estudios Internacionales del Centro de Investigación y Docencia Económicas, A.C. (CIDE) desde 1983. Fue Director de la propia División de Estudios Internacionales del CIDE de 1996 a 1999.\n\nObtuvo la Licenciatura en Relaciones Internacionales en El Colegio de México y la Maestría y el Doctorado en Estudios Internacionales en la Universidad de Miami.\n\nEs miembro del Sistema Nacional de Investigadores, Nivel 2. Ha publicado más de 40 artículos en los temas de Política Exterior de México, Relaciones México-Estados Unidos, Narcotráfico y Seguridad Nacional en libros y revistas especializadas como Current History, Journal of Interamerican Studies and World Affairs y Annals of the American Academy of Political and Social Science.\nEntre sus publicaciones se encuentran: John Bailey y Jorge Chabat (eds), Transnational crime and public security: challenges to Mexico and the United States. San Diego: University of California San Diego, 2002; “Violence in Mexico: in search of an explanation”, en Bruce Bagley, Hanna Kassab y Jonathan Rosen (eds), Reconceptualizing security in the western hewmisphere in the 21st Century”, Nueva York: Lexington Books, 2015.\n\nActualmente es Profesor visitante en el Departamento de Estudios del Pacífico del Centro Universitario de Ciencias Sociales y Humanidades de la Universidad de Guadalajara. En 2014 la Universidad Juárez Autónoma de Tabasco le otorgó el Premio Juchimán de Plata por su trayectoria académica en el tema de Seguridad Nacional.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("3B"));
                break;
            ...
            case 40:
                ...
                this.dato = "Diplomático mexicano";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("3B"));
                break;
            ...
            case 55:
                ...
                this.dato = "Gobernador de Puebla";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 56:
                ...
                this.dato = "Ex Embajador y Ex Secretario de Educación de Puebla";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("34C"));
                break;
            case 57:
                ...
                this.dato = "Secretaría de Educación de Puebla";
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("34C"));
                break;
            ...
            case 65:
                ...
                this.dato = "Estudios Superiores en Ciencias Sociales";

                this.descripcion = "Miembro del Instituto de Investigación para el desarrollo. Doctor por la Escuela de Estudios Superiores en Ciencias Sociales. Ha realizado estancias de investigación en México y Brasil.\n\n"+
                    "Entre sus temas de investigación se encuentra las políticas de gobernanza frente a las connivencias entre actores criminales e institucionales, la corrupción y la violencia utilizada por actores criminales, las políticas públicas de lucha contra la corrupción, las políticas de seguridad: entre eficacidad y legitimidad.\nAlgunas de sus  publicaciones son: “Droga, corrupción y metamorfosis política (comparación entre México y Brasil)” (1999); “Droga y poder (de México al paraíso)” (1999); “La transformación de espacios urbanos ventrales: riesgos, desafíos y estrategias en un contexto de desarrollo sostenido urbano” (2007); “Margen social y territorial en Mérida (México)” (2008).";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("6A"));
                break;
            case 66:
            ...
            case 90:
                ...
                this.dato = "(Unión Europea) " +
                        "Organización Internacional para las Migraciones";
                this.descripcion = "Es especialista de la Organización Internacional para las Migraciones (OIM) en temas sobre la migración laboral, integración, migración y  desarrollo.\n\nActualmente se desempeña en la oficina para Centro América de la OIM, organismo en el cual ha participado en la Unión Europea, Noruega y Suiza. Estuvo a cargo de la Red Independiente de la OIM para la Migración Laboral y Expertos en Integración (LINET), y publicó una serie de estudios comparativos sobre diversos aspectos del desarrollo de la política de migración y de integración de los inmigrantes en el mercado laboral.\nAntes de unirse a la OIM, trabajó en temas de libertad de movimiento en la Oficina de Instituciones Democráticas y Derechos Humanos de la Organización para la Seguridad y la Cooperación en Europa (OSCE ODIHR). ";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 91:
                ...
                this.dato = "Activista de los Derechos de los Migrantes";
            ...
            case 92:
                ...
                this.dato = "Defensora de los Derechos Humanos";
            ...
            case 93:
                ...
                this.dato = "Universidad de Florencia";
            ...
            case 99:
                ...
                this.dato = "(CIDE, Aguascalientes) – Crimen organizado";
            ...
            case 100:
                ...
                this.dato = "(INCIDE, El Salvador) – Economía";
            ...
            case 109:
                ...
                this.dato = "Universität Bielefeld";
            ...
            case 111:
                ...
                this.dato = "Universidad Nacional Autónoma de México (UNAM)";

                this.descripcion = "Es licenciado en Economía por la UNAM, con estudios de posgrado en la London School of Economics. Ha sido nombrado por la UNAM profesor emérito y Doctor Honoris Causa por la UAM.\nEs investigador del Sistema Nacional de Investigadores. Actualmente es coordinador del Programa Universitario de Estudios del Desarrollo, colaborador semanal del periódico La Jornada, miembro del consejo editorial de la revista ECONOMÍAunam de la UNAM y miembro del Instituto de Estudios para la Transición Democrática y de la Academia Mexicana de Economía Política. Además, es presidente de la Fundación Pereyra, A.C. y director de la revista Configuraciones.\n\n" +
            ...
            case 113:
                ...
                this.descripcion = "Gilda Waldman realizó la maestría y doctorado en Sociología en la Facultad de Ciencias políticas y Sociales en la UNAM y defendió el doctorado en la especialización en estudios judaicos en la Universidad Latino-americana.\n\nLa Dra. Gilda Waldman tiene entre sus publicaciones el libro Melancolía y utopía. La reflexión de la Escuela de Frankfurt en torno a la crisis de la cultura (1999), Memorias (in)cognitas: contiendas en la Historia.\nWaldman fue coordinadora de la Maestría y Doctorado en Sociología de la División de Estudios de Posgrado (UNAM) y posteriormente responsable de la Maestría en Estudios Políticos y Sociales (UNAM).\n\nEs miembro del Sistema Nacional de Investigadores y del Comité Académico del Programa de Posgrado en Ciencias  Políticas y Sociales (UNAM). Waldman ha colaborado en ensayos, traducciones, críticas literarias de la Revista de la Universidad, y de Casa del Tiempo, así como en otros periódicos. Además es socia en el programa de Radio UNAM Tras las huellas de los libros, autores y lectores.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 114:
                ...
                this.descripcion = "La Dra. Paulina Martínez González, es docente e investigadora de la Universidad de Guadalajara en el Departamento de Estudios sobre Movimientos Sociales y de la Maestría en Ciencia Política del Centro Universitario de la Ciénega.\nPertenece al Sistema Nacional de Investigadores (nivel I) y como profesora del Centro Universitario de Ciencias Sociales y Humanidades imparte cátedra de Ecología Política y de Enfoques Teóricos de la Ciencia Política.\n\n" +
                        "Entre algunas de sus publicaciones podemos señalar: \"Cultura política, emociones y democracia.\nEl movimiento por el 28 de Mayo en Guadalajara\" (2006); \"Impactos de la contaminación del Río Santiago en el bienestar de los habitantes de El Salto, Jalisco Espacio Abierto\" (2009); “La lucha por la justicia ambiental en Jalisco: Un Salto de Vida, por la defensa del Santiago” (2010); \"Semblanza de un conflicto ambiental. San Francisco de Ixcatán, en defensa de la vida, la naturaleza y la cultura\"(2012); \"Participación ciudadana y desarrollo democrático\" (2013); \"Límites y posibilidades de la participación política en las democracias contemporáneas. Reflexiones sobre el caso mexicano\" (2013); \"La pesca artesanal en Jalisco. Conflictos en torno a la conservación biocultural y la reproducción del capital. El caso de Careyitos\" (2014); \"Redes y relaciones en la vida social de los ocotlenses\" (2014).";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 119:
                ...
                this.dato = "Universidad Libre de Berlín";
            ...
            case 120:
                ...
                this.descripcion = "Ofrece su visión como escritor independiente y crítico literario. Nació en 1971, en Salzburgo; estudió alemán, filosofía y periodismo.\nTrabaja como escritor independiente, lector y director de talleres de escritura, además de algunos programas de radio (Ö1). Ocasionalmente escribe reportajes, críticas para todo tipo de revistas y periódicos.\n\nEs miembro del PEN Club de Austria. Cuenta con numerosas publicaciones en antologías y revistas literarias en Austria, Alemania y Suiza. Ha participado en más de cien lecturas en festivales, en casas la literatura y bibliotecas en Austria, y en muchos países europeos. Por su trabajo ha recibido varios premios y becas.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("32M"));
                break;
            case 121:
            ...
            case 125:
                ...
                this.descripcion = "";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("32C","32Q"));
                break;
            case 126:
                this.nombre = "Paulo";
            ...
            case 163:
                ...
                this.dato = "Universidad de Harvard";

                this.descripcion = "Maestro y Doctor en Educación por la Universidad de Harvard. Profesor de la Universidad de Guadalajara, Investigador Nacional Nivel III, Miembro de la Academia Mexicana de Ciencias y Jefe del Departamento de Estudios de la Comunicación Social de la Universidad de Guadalajara.\n\nEspecialista en temas de recepción de audiencias y educomunicación. Coordinador General de la Cátedra UNESCO-UdeG sobre Alfabetización Mediática e Informacional; Co-Coordinador Internacional del Observatorio Iberoamericano de Ficción Televisiva (OBITEL) y Coordinador en México del Grupo de Estudios de Recepción de la Asociación Mexicana de Investigadores de la Comunicación (AMIC), de la cual es socio fundador. Última publicación: (Re)invención de géneros y formatos de la ficción televisiva (Globo Universidade, 2016).";
            ...
            case 164:
                ...
                this.descripcion = "Doctora en Comunicación Audiovisual por la Universidad Pompeu Fabra de Barcelona. Tiene un Master en Teoría y Práctica del Cine Documental por la Universidad Autónoma de Barcelona.\nActualmente trabaja como profesora investigadora en el Departamento de Estudios de la Comunicación Social, del CUCSH, en la Universidad de Guadalajara. Sus líneas de investigación son: el análisis fílmico, la ética informativa en medios audiovisuales, las teorías de las imágenes y la televisión contemporánea.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
...
*/
            ...
            case 176:
                ...
                this.descripcion = "Noemí Gómez es académica – investigadora del Departamento de Psicología, Educación y Salud, del Instituto Tecnológico y de Estudios Superiores de Occidente (ITESO). Estudió la licenciatura en Psicología, posteriormente la maestría en Investigación Educativa y el doctorado en Estudios Científico Sociales.\n\nEs miembro del Sistema Nacional de Investigadores. Sus  preocupaciones académicas han girado en torno a la pregunta sobre los actores sociales, en particular sobre sus diferenciales de actoría.\nEn esta línea, ha tenido acercamiento con diversos sujetos: docentes, directores, estudiantes, niños en situación de calle, indígenas mixtecos, indígenas huicholes, habitantes de colonias populares y personas con intento de suicidio. Sus trabajos de investigación han girado alrededor de la conformación de la identidad, las formas simbólicas, la capacidad de agencia y las emociones sociales.\n\nHa publicado también algunos trabajos sobre la investigación de corte interpretativa. Algunas de sus principales obras: Habitar el lugar imaginado. El libro: “Formas de construir la ciudad desde un proyecto educativo político”; ha publicado diversos capítulos y artículos como: “La intervención socio educativa.\n\nCuando se juega en la cancha del otro“, “La propuesta pedagógica de Paulo Freire”, “Identidad docente. Vida personal – vida profesional”, “La investigación educativa: del sectarismo a la diversidad teórica y metodológica”, “Esperanza y capacidad de agencia”, “El sufrimiento y el compromiso social”, “identidad y memoria colectiva”, “Los mixtecos sobre la vía del tren”, entre otras.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 177:
                ...
                this.dato = "Universidad de París";
            ...
            case 185:
                ...
                this.descripcion = "Nació en 1977 en la ciudad de Guadalajara (México). Estudió Física y desde 1999 se ha dedicado a la divulgación científica en museos, revistas, diarios y programas radiofónicos, labor por la cual en 2008 obtuvo el Premio de Ciencia, Tecnología e Innovación de Jalisco.\n\nEs miembro del comité editorial del Journal of Science Communication y socio titular de la Sociedad Mexicana para la Divulgación de la Ciencia y la Técnica.\n\nHa trabajado como docente de secundaria, preparatoria y licenciatura de una serie de materias que, no por variopinta, debería pasar por exótica: Temas selectos de Física, Cálculo diferencial e integral, Introducción a la Física y la Química, Matemáticas, Cultura mexicana, Museología científica, Lengua y cultura italianas, Lectura y comprensión, Fotografía, entre otras.\n\nHa sido becario de la American Association of Museums y del Fondo Nacional para la Cultura y las Artes de México, además de involucrarse en la creación y dirección de museos interactivos y exposiciones de ciencia y tecnología en varias regiones de la República mexicana. Promotor y fundador del Coloquio Internacional de Cultura Científica en la Feria Internacional del Libro de Guadalajara, escribe una página dominical sobre temas de ciencia y sociedad en los diarios La Jornada Jalisco y La Jornada Michoacán, además de una columna mensual en la revista Ciencia y Desarrollo, editada por el Consejo Nacional de Ciencia y Tecnología de México. Es autor de Más allá del océano. Ciencia y ciudadanos en Jalisco y Trieste, y de Almanaque. Historias de ciencia y poesía, traducido al portugués y publicado en Brasil por la Editorial de la Universidad de Campinas";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("20H"));
                break;
            case 186:
                ...
                this.descripcion = "Doctor en Educación en la Universidad de Buenos Aires. Reside en Brasil desde hace más de 20 años, donde es profesor de la Universidad del Estado de Río de Janeiro (UERJ).\n\n Actualmente, ejerce como secretario ejecutivo del Consejo Latinoamericano de Ciencias Sociales (CLACSO).\n\n" +
                        ...
                        "Desde 1999, miembro de la Carrera de Investigador del Consejo Nacional de Investigaciones Científicas de Brasil (CNPq).\nInvestigador categoría 1.\n\n" +
            ...
            case 187:
                ...
                this.descripcion = "Es Doctor en Ciencias Biomédicas por la UNAM. Profesor Investigador Titular C de la Universidad de Guadalajara.\nProfesor del Posgrado en Ciencias Biomédicas CUCS-CUCBA, con registro en el Padrón de Excelencia del CONACyT.  Profesor de la Maestría en Comunicación de la Ciencia y la Cultura con registro en el Padrón de Excelencia del CONACyT, del ITESO. Miembro del Sistema Nacional de Investigadores de 1985 a 1997. Ha publicado más de 50 artículos científicos en Revistas nacionales e internacionales.\n\nFue Jefe del Departamento de Biología Celular y Molecular en 1994-1995,  Director de la División de Ciencias Biológicas 1995-1998, Jefe de Investigación y Posgrado de la de la UdeG de 1998 a 2000. Columnista de: Siglo 21 (1993). Armario de El Occidental (1995-2000), MURAL del grupo REFORMA (2000-2009).\n\nHa publicado en diferentes revistas culturales como Complot, Tragaluz, Replicante, Luvina y en otras académicas como Renglones (ITESO). Intereses: Ciencia, Cine, Literatura. Películas favoritas Movie-Art: Métropolis-Fritz Lang.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 197:
                ...
                this.dato = "El Colegio de México";
            ...
            case 201:
                ...
                this.descripcion = "Es sociólogo y especialista en creencias religiones y cultura.\n" +
                        "Desde su formación comprendió que el reto religioso es acoger y llevar a cabo un discernimiento sobre la voluntad de Dios en la realidad social.\n\nComo estudiante de economía, en los años posteriores a la gran renovación eclesial que fue el Concilio Vaticano II, participó en iniciativas progresistas de reflexión universitaria.\nEsto lo llevó a su primer trabajo profesional en una organización de desarrollo rural. Pero desde entonces, Bernardo sostuvo una tenaz colaboración en diversos movimientos de reflexión cristiana.\n\nCrecer con otros ha sido la marca distintiva de su trayectoria. En los años ochentas realizó una labor más específica como Secretario General de movimientos internacionales de estudiantes católicos en Perú, Francia y Suiza.\n\nFueron 10 años de interacción con las jerarquías eclesiales en todo el mundo que le permitieron conocer muchos aspectos de su funcionamiento. En esta época también se especializó en sociología de la religión.\n" +
                        "A su regreso a México, con una visión acorde a los nuevos tiempos y a sus exigencias, estuvo nueve años como subdirector de la Fundación de Desarrollo Rural y otros nueve en las fundaciones Invertir, Procura y Vamos.\n\nPara el cambio de siglo, su compromiso abarcó un nuevo giro: la participación de la ciudadanía en la acción gubernamental. Los próximos 10 años, asumió el cargo de Consejero electoral propietario en el Instituto Electoral del Estado de México y  posteriormente del IFE en el mismo estado. Entre uno y otro  cargo, coordinó el Dictamen Ciudadano, un proyecto social de observación electoral. Su experiencia y visión en este campo es invaluable. ";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 209:
                ...
                this.dato = "Universidad Autónoma de Coahuila";
            ...
            case 229:
                ...
                this.dato = "Facultad de Ciencias Políticas y Sociales";
            ...
            case 231:
                ...
                this.dato = "Universidad Autónoma Metropolitana";
            ...
            case 232:
                ...
                this.descripcion = "Profesor de Historia Contemporánea de la Universidad Complutense de Madrid; fue Director de la Fundación Gregorio Marañón,  Subdirector del Instituto Universitario Ortega y Gasset.\n\nActualmente dirige la publicación \"El Pulso de España\" de Metroscopia, think tank español que hace estudios sociales para instituciones como el diario El País.\nEn su trayectoria docente ha sido también profesor en la Universidad Carlos III de Madrid y ha sido Visiting Scholar con la categoría de Senior Member Associated del St. Antony's College de la Universidad de Oxford donde trabajó sobre \"1914: El año que cambió la historia\", que ha sido objeto de su último libro.\n\nSu trayectoria investigadora fue reconocida con el Premio “Julián Marías” de Humanidades de la Comunidad de Madrid en su edición de 2012. Entre otros reconocimientos es miembro correspondiente de la Sociedad Peruana de la Historia.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("25C"));
                break;
            case 233:
            ...
            case 237:
                this.nombre = "Kim";
                this.apellidos = "Diaz";
                this.dato = "Universidad de Texas";
            ...
            case 238:
                this.nombre = "Santiago";
                this.apellidos = "Rey";
                this.dato = "New School for Social Research";

                this.descripcion = "Santiago Rey es doctor en filosofía por la New School for Social Research y profesor en la Universidad El Bosque y la Universidad de los Andes en Bogotá, Colombia. Su disertación doctoral “Words made Flesh.\n\n A Stereoscopic Account of Conceptual Praxis” fue reconocida con el Hans Jonas Award in Philosophy y está siendo preparada para su publicación. Su trabajo gira en torno a la hermenéutica filosófica y el pragmatismo americano (tanto en su vertiente clásica como contemporánea), buscando posibles puntos de intersección entre tradiciones filosóficas que usualmente se presentan como antagónicas.\n\nHa publicado artículos sobre estos temas, y recientemente realizó la traducción del libro “Violence: Thinking without Banisters” de Richard J. Bernstein para la editorial Gedisa. Actualmente prepara la traducción del último libro de Bernstein “Pragmatic Encounters”, también para editorial Gedisa, y trabaja en el proyecto de edición de las obras completas del filósofo colombiano Carlos B. Gutiérrez. Hace parte del grupo de investigación “Normas y justificación” de la Universidad El Bosque.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("26A"));
                break;
            case 239:
                ...
                this.descripcion = "Aureliano es doctor en Filosofía por la UNAM.\nActualmente es profesor-investigador de tiempo completo en la Universidad de Guanajuato; ha sido profesor e investigador en instituciones privadas (Enciclopedia de México) y públicas (Escuela Nacional de Restauración SEP-INAH; Facultad de Ciencias Políticas, Escuela Nacional de Artes Plásticas, UNAM).\n\nHa publicado ensayos sobre cultura, política y sociedad en revistas universitarias y suplementos culturales y políticos, y artículos sobre filosofía e historia en revistas especializadas.\nEntre sus libros se cuentan: Juan Diego; Notas sobre la cultura mexicana (1979); El instante de Emilio Uranga (1993); Los grandes problemas nacionales 1995; Las tareas filosóficas del presente (1999); Crisis de la razón histórica y Hacia la nada.\n\nEnsayo de interpretación histórica (2000), Ideas, políticas e historias del humanismo en Guanajuato (2001) y Contribución a la crítica de la razón histórica (2004).\nLa ceguera del Cíclope. Ensayos sobre historia y ciencia. (2009) e Historiografía e identidad y otros ensayos sobre la filosofía de la historia mexicana. (2009).";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
                this.eventos = new ArrayList<String>(Arrays.asList("26A"));
                break;
            case 240:
            ...
            case 241:
                ...
                this.descripcion = "Es profesor investigador de la Universidad de Guadalajara, miembro del Sistema Nacional de Investigadores.\n\nCuenta con estudios de Licenciatura y maestría en Derecho por la Universidad de Guadalajara, maestro y doctor en Derechos Humanos por el Instituto de Derechos Humanos “Bartolomé de las Casas” de la Universidad Carlos III de Madrid y la especialidad en justicia constitucional por la Universidad de Pisa. Autor de diversas publicaciones nacionales e internacionales en temas de derechos humanos, entre los que destacan los libros: El constitucionalismo ante los instrumentos internacionales de derechos fundamentales, Ubijus-Ara, México-Perú, 2012 y El constitucionalismo ante el control de convencionalidad su debate actual, México, Porrúa, 2015.\n\nFue Director del Instituto de Investigación y Capacitación en Derechos Humanos en la Comisión Estatal de Derechos Humanos Jalisco, México. Actualmente Director de la División de Estudios Jurídicos en el Centro Universitario de Ciencias Sociales y Humanidades de la Universidad de Guadalajara.";
            ...
            case 248:
                ...
                this.dato = "Universidad Complutense de Madrid";
            ...
            case 254:
                ...
                this.dato = "Periodista Cultural.";
                this.descripcion = "Licenciado en artes y maestrante en Historia y Crítica del arte.\nRealizó estudios de Periodismo Cultural con los maestros Hugo Gutiérrez Vega, Humberto Musacchio, Braulio Peralta y Héctor Perea.\nEspecialista en Documental Cinematográfico por el CUEC-UNAM, Director del Foro de Periodismo Cultural en la FIL Guadalajara, Miembro del Comité de selección de cine documental en el Festival Internacional de Cine en Guadalajara. Director de EXPRESIONES La Revista, Director del Seminario Internacional de Crítica de Arte.\n\nDirector de Letras en la Mar Encuentro Internacional de Poetas y el Arte en Puerto Vallarta, Jalisco. Director de la Cátedra Hugo Gutiérrez Vega de Periodismo Cultural y las Letras de Universidad de Guadalajara. ";
            ...
            case 255:
                this.nombre = "Viktor";
                this.apellidos = "Boga";
                this.dato = "Universidad Nacional Autónoma de México";

                this.descripcion = "Maestro en Literatura, con especialidad en Letras de Jalisco, por la Secretaría de Educación Jalisco y la Secretaría de Cultura del Gobierno de Jalisco, con el tema de tesis El erotismo en la poesía de Hugo Gutiérrez Vega. Además es productor y director de cine.\n\nRealizó estudios de cine en el Departamento de Imagen y Sonido de la Universidad de Guadalajara, es Diplomado en Cine documental por la Universidad Nacional Autónoma de México. Es director de Cinematógrafo Arte Audiovisual donde promueve y fomenta la creación de públicos en el área documental a través del programa DOCUMENTArte una mirada al cine documental con sede en el Festival Internacional de Cine de Guadalajara. Actualmente, es Secretario de la Cátedra Hugo Gutiérrez Vega de la Universidad de Guadalajara. ";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(28));
                this.eventos = new ArrayList<String>(Arrays.asList("28C"));
                break;
            case 256:
                ...
                this.dato = "Universidad Iberoamericana";
            ...
            case 259:
                ...
                this.dato = "Universidad de Bucarest, Rumania";

                this.descripcion = "Estudió filología germánica en la Universidad de Bucarest, Rumania.\nEn 1986  obtuvo la beca DAAD que otorga el gobierno alemán y estudió un semestre en la Universidad de Freiburg, Alemania. En el 2005 obtuvo el grado de Maestra por la Universidad de Guadalajara, México.\n\nEs profesora investigadora titular en el Departamento de Estudios Literarios de la Universidad de Guadalajara y Coordina del Taller de Traducción del mismo departamento. En el 2007, por un semestre, fue profesora huésped en la Universidad de Zagreb, Croacia. Publicó el ensayo Tiempo y espacio histórico en El Perfume de Patrick Süskind (Cálamo, 2000), Un acercamiento pragmático al apodo burlesco (UDG, 2007) y tradujo del alemán el libro de Christine Schulz-Reis Filosofía. Conocimiento básico para el diálogo (Arlequín, 2007).\nEn su investigación actualmente muestra interés por los orígenes del mestizaje durante la conquista de México.";
            ...
            case 262:
                ...
                this.descripcion = "Es originaria de Ensenada, Baja California; doctorado de UCLA; especialista en teatro barroco (principalmente de Calderón y de Sor Juana); Profesora Emérita de California State Polytechnic University, Pomona; profesora visitante en universidades de EE.UU., Canadá y España.\n\nHa sido presidenta  de la Modern Language Association  del Pacífico, directora del Instituto de Verano de Lenguas y Cultura Hispánicas de UCSB, y vicepresidente en Norteamérica de la Asociación Internacional de Teatro Español y Novohispano de los Siglos de Oro.Ha publicado numerosos ensayos y reseñas en revistas prestigiosas y dictado conferencias en congresos y universidades en  Canadá, Europa, Estados Unidos e Hispanoamérica. Participa en consejos editoriales de revistas importantes en su campo de investigación  y en mesas directivas de organizaciones culturales de la ciudad de Los Angeles, California";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 265:
                ...
                this.dato = "Universidad de Córdoba, España";

                this.descripcion = "Realizó estudios de doctorado en la Universidad de Córdoba, España. En el año 2000 su tesis doctoral fue publicada por el Instituto Nacional de Estudios Históricos de la Revolución Mexicana.\nPosteriormente publicó Habla y sociedad (2003). Participó como autora en el libro Análisis del discurso: raza y género (2003).  Ambos publicados por la Universidad de Guadalajara. Coordinó el libro Textos y argumentos (2008) publicado por la Universidad Veracruzana.\n\nHa publicado artículos, entre otros, en las revistas: Oralia, Tonos Digital y Signos. Sus  líneas de investigación han sido el análisis sociolingüístico de textos literarios y textos de habla, género y lengua, análisis conversacional y análisis del discurso.\n\nHa sido profesora en la Universidad de Guadalajara por más de quince años. De 2008 a 2010 impartió cursos como profesora invitada en la Universidad de Texas, en Austin. De 2010 a 2013 participó como instructora en lengua y literatura hispana, acreditada por College Board, en el proyecto Knwoledge is Power Program en la ciudad de Austin, Texas. Actualmente es Jefa del Departamento de Letras de la Universidad de Guadalajara.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 271:
                ...
                this.dato = "Universidad Vanderbilt";
            ...
            case 274:
                ...
                this.dato = "Universidad Autónoma de Madrid";

                this.descripcion = "Es doctor en Análisis del Discurso por la Universidad Autónoma de Madrid. Ha publicado los siguientes títulos de investigación en Análisis del Discurso: \n-Teoría del discurso (2003)\n-La rebelión zapatista en el diario\n-El País (2004),Fernando del Paso\n-Vértigos del cuerpo, rupturas de la historia (2013)\n-En colaboración: Representación y racismo (2004)\n-Discurso, raza y género (2007)\n-Textos y Argumentos (2008)\n-De política lingüística y análisis del discurso.\nComo narrador ha publicado las novelas:\n-Viaje a los Olivos (1998)\n-Bajo la niebla de París (2005)\n-Snapshot (2012)\n-El hombre higiénico (2013).\n\nPertenece al Sistema Nacional de Investigadores. Imparte cursos de Análisis del Discurso y Teoría Literaria. Actualmente es profesor e investigador de tiempo completo en la Universidad de Guadalajara. Acaba de regresar de una estancia académica de un año en la Universidad de Bielefeld, Alemania.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 276:
                ...
                this.dato = "Universidad de Córdoba";
            ...
            case 277:
                ...
                this.descripcion = "Nació en Montevideo, Uruguay, en 1953 y reside en Suecia, país del que es ciudadano, desde 1978. Es Doctor en Filosofía y Letras, con especialidad en Literatura en Lengua Española por la Universidad de Gotemburgo, Suecia (1990), y Docent (Associate professor, 1997). Desde 1995 y hasta la actualidad se desempeña como investigador y profesor universitario en la Universidad de Uppsala. Sus campos de investigación son Romanticismo, Narrativa contemporánea de Hispanoamérica, Literatura Colonial y Siglo de Oro.\n\n" +
                        ...
                        "Es autor de libros de investigación y de más de una treintena de artículos científicos publicados, así como de novelas, colecciones de cuentos y poemarios publicados en editoriales nacionales e internacionales.\n\nY ha recibido varios premios y reconocimientos, entre otros el Premio Narradores de la Banda Oriental (1992); La maison de l´Amérique Latine en Francia, en el Premio Juan Rulfo de cuentos (1996), el primer premio del Ministerio de Educación y Cultura de Uruguay en Ensayo y en Narrativa (1990, 1996 y 2000) así como el Premio de Novela Breve Álvaro Cepeda Samudio, en Colombia, en 2003. ";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 279:
                ...
                this.dato = "Escuela Normal Superior de Jalisco";
            ...
            case 285:
                ...
                this.descripcion = "Es Doctor en Filosofía por la Universidad de Viena, Austria. Actualmente es profesor investigador en el Departamento de Estudios Literarios e imparte cátedra en la Licenciatura de Letras Hispánicas de la Universidad de Guadalajara, y es coordinador del Doctorado en Humanidades del Centro Universitario de Ciencias Sociales y Humanidades.\n\nComo autor literario obtuvo el Premio Nacional Juan Rulfo para Primera Novela 1998, otorgado por el Instituto Nacional de Bellas Artes por su novela El cangrejo de Beethoven.\n\nTiene, además, los libros de ficción La música y otras razones para contar (1994);  Erato. Ars amatoria en Guadalajara (1998); y La oportunidad y otros relatos (2007).\nObtuvo el Premio Nacional de Historia Edmundo O’Gorman 2011 otorgado por el Instituto Nacional de Antropología e Historia por su ensayo sobre novela histórica Utilización de la historia en la narrativa (2010).\nActualmente es Coordinador del Doctorado en Humanidades, de nuestra casa de estudios.";
                this.eventos_organizador = new ArrayList<Integer>(Arrays.asList(0));
            ...
            case 321:
                ...
                this.dato = "The New School for Social Research";
